...
#Create Test Tasks
Task.create(name: "Brainstorm story ideas", description: "Come up with 3 viable story ideas.", goal_id: 1, start_date: DateTime.now, end_date: Date.new(2017, 12, 15), status: "incomplete")
Task.create(name: "Choose best idea", description: "Pick my favorite of the 3 ideas.", goal_id: 1, start_date: DateTime.now, end_date: Date.new(2017, 12, 18), status: "incomplete")
Task.create(name: "Write an outline", description: "Write a basic outline, just to start", goal_id: 1, start_date: DateTime.now, end_date: Date.new(2018, 1, 15), status: "incomplete")

Task.create(name: "Sign up for Flatiron School", description: "Take free bootcamp prep course at Flatiron.", goal_id: 2, start_date: DateTime.now, end_date: Date.new(2018, 2, 15), status: "incomplete")
